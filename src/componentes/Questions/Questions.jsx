        ...
        <>
            <div className="faq-section">
                ...
                <div className="faq-item">
                    ...
                    <p> Un Sitio web puede tener diferentes propósitos, como proporcionar información, promocionar una empresa, brindar servicios, compartir contenido, etc. No necesariamente implica la venta de productos o servicios en línea. Un e-commerce es un sitio web diseñado para facilitar la compra y venta de productos o servicios online.</p>
                </div>
